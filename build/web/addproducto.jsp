        ...
        <div class="page-content p-5" id="content">
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <form name="Agregar" action="ControllerImagen" method="POST" class = "form-horizonta" enctype="multipart/form-data">
                        ...
                        <fieldset class="border p-2 border-dark">
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="categoria" style="color: black">
                            ...
                            <div class= "col-sm-6">
                                <label for="modelo" style="color: white">Descripcion</label>
                        ...
                        <br/>
                        <button type="submit" class="btn btn-primary" name="action">Registrar</button>
                    </form>
