        ...
        <header>
           ...
           <li><a href="Ubicacion.jsp"><i class="fa fa-map-marker"></i> Parque Industrial, Callao 07006</a></li>
                    ...
                    <ul class="header-links pull-right">
                        <li><a href="#"><i class="fa fa-dollar"></i> Soles</a></li>
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li><a href="#">Clavo de cabeza</a></li>
                        <li><a href="#">Punzonador</a></li>
                        <li><a href="#">Pernos de expanción</a></li>
                        <li><a href="#">Brocas</a></li>
                    </ul>
                    <!-- /NAV -->
                </div>
                <!-- /responsive-nav -->
